...
exports.ProjectMasterBffController = void 0;
const common_1 = require("@nestjs/common");
const project_master_service_1 = require("./project-master.service");
let ProjectMasterBffController = class ProjectMasterBffController {
    constructor(service) {
...
exports.ProjectMasterBffController = ProjectMasterBffController;
__decorate([
    (0, common_1.Get)(),
...
], ProjectMasterBffController.prototype, "list", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Headers)('x-tenant-id')),
    __param(1, (0, common_1.Headers)('x-user-id')),
    ...
    __metadata("design:returntype", Promise)
], ProjectMasterBffController.prototype, "findById", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Headers)('x-tenant-id')),
    __param(1, (0, common_1.Headers)('x-user-id')),
    ...
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
], ProjectMasterBffController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Headers)('x-tenant-id')),
    __param(1, (0, common_1.Headers)('x-user-id')),
    ...
    __metadata("design:returntype", Promise)
], ProjectMasterBffController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, String, String, Object]),
    __metadata("design:returntype", Promise)
], ProjectMasterBffController.prototype, "deactivate", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, String, String, Object]),
    __metadata("design:returntype", Promise)
], ProjectMasterBffController.prototype, "reactivate", null);
exports.ProjectMasterBffController = ProjectMasterBffController = __decorate([
    (0, common_1.Controller)('master-data/project-master'),
    __metadata("design:paramtypes", [project_master_service_1.ProjectMasterBffService])
], ProjectMasterBffController);
