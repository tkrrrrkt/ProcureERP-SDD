/**
 * API Error Codes: Warehouse (倉庫マスタ)
 *
 * SSoT: packages/contracts/src/api/errors/warehouse-error.ts
 */
...
export const WarehouseErrorHttpStatus: Record<WarehouseErrorCode, number> = {
  [WarehouseErrorCode.WAREHOUSE_NOT_FOUND]: 404,
  [WarehouseErrorCode.WAREHOUSE_CODE_DUPLICATE]: 409,
  [WarehouseErrorCode.INVALID_WAREHOUSE_CODE_FORMAT]: 422,
  [WarehouseErrorCode.INVALID_WAREHOUSE_CODE_LENGTH]: 422,
  [WarehouseErrorCode.INVALID_WAREHOUSE_CODE_CHARS]: 422,
  [WarehouseErrorCode.WAREHOUSE_GROUP_NOT_FOUND]: 404,
  [WarehouseErrorCode.DEFAULT_RECEIVING_ALREADY_SET]: 409,
  [WarehouseErrorCode.CANNOT_DEACTIVATE_DEFAULT_RECEIVING]: 422,
  [WarehouseErrorCode.CONCURRENT_UPDATE]: 409,
};
